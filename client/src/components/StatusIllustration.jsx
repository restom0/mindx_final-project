function StatusIllustration({variant = "notFound", title}) {
  ...
  return (
    ...
    >
      ...
      <rect x="36" y="44" width="448" height="272" rx="28" fill="url(#statusGradient)" opacity="0.72"/>
      ...
      {isServerDown ? (
        <>
          <rect x="96" y="224" width="328" height="38" rx="19" fill="color-mix(in srgb, var(--color-danger) 16%, var(--color-surface))"/>
          <path
        ...
        <>
          <rect x="96" y="224" width="328" height="38" rx="19" fill="color-mix(in srgb, var(--color-accent) 14%, var(--color-surface))"/>
          <path
